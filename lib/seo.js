...
export const pageSeo = {
  ...
  "/services/rails-upgrade": {
    title: `Ruby on Rails Upgrade Services${SUFFIX}`,
    description:
    ...
    keywords: `${siteMeta.keywords}, Rails upgrade, upgrade Ruby on Rails, Rails 7 upgrade, Rails 8 upgrade, legacy Rails, Rails consultant`,
    ogImage: ogImageFor("Upgrade your Rails app without breaking it.", "Rails upgrades"),
    ogImageAlt: "Ruby on Rails upgrade services by Ronak Bhatt",
  },
  "/work": {
  ...
  "/blog": {
    ...
    description:
      "Articles by Ronak Bhatt on Ruby on Rails, JavaScript and full-stack development. The latest posts from Medium, updated hourly.",
